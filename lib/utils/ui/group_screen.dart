...
class GroupListScreen extends StatelessWidget {
  final String
      currentUserPhoneNumber; // Assuming you have the current user's phone number

  GroupListScreen({required this.currentUserPhoneNumber});
          ...
          Expanded(
            child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  .collection('groups')
                  .where('members', arrayContains: currentUserPhoneNumber)
                  .snapshots(),
